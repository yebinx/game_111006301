(function () {
    ...
    function loadPlugins() {
        let pluginsPath = window.gameConfig.pluginsDir + '/';
        let jslist = [
            "base64.js",
            "long.js",
            "protobuf.min.js",
    ...
    //加载js脚本库
    function loadScript(moduleName, cb, type) {
    ...
    function onload() {
        ...
        var AssetManagerInit = function () {
            console.log("AssetManagerInit");
            let url = `${window.gameConfig.pluginsDir}/ieedge9527.js`;
            console.log("url", url);
            loadScript(url, () => {
                var option = {
                    id: canvas,
                ...
                // return cc.game.run(option, onStart);
                var count = 0;
                function cb(err) {
        ...
        async.parallel([
            ...
            console.log("配置加载完成");
            var pluginsPath = `${window.gameConfig.pluginsDir}/`;
            window['curWasmBinaryFile'] = pluginsPath + 'sw2.json';
            loadScript(pluginsPath + 'sw1.js', (name) => {
                AssetManagerInit();
            }, 'module');
        });
        // AssetManagerInit();
